		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Eventos no SAP UI5",
									"targetURL": "#treinaui5eventosui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"treinaui5eventosui5-display": {
								"semanticObject": "treinaui5eventosui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=treinaui5.eventosui5",
									"url": sap.ui.require.toUrl("treinaui5/eventosui5")
								}
							}
						}
					}
